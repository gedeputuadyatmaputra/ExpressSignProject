...
import capstone.prject.express.classifier.face.FaceAssets
import capstone.prject.express.classifier.face.FaceClassifier
...
class FaceDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonanalize = findViewById(R.id.btn_scanner_face)
        ...
        labels = FaceAssets.loadLabels(this)
    ...
    private fun analyzeImage() {
        val classifier = FaceClassifier(assets, "FaceDetectModel.tflite", "facedetect.txt", 150)
